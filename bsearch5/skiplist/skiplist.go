...
func main() {
	...
	for i := 0; i < sl.level-1; i++ {
		...
		for cur.forwards[i] != nil {
			...
			fmt.Print(cur.forwards[i].v)
			fmt.Println()
			cur = cur.forwards[i]
		}

	}
	// fmt.Print(sl.head.v, "----", sl.head.level, "-----", sl.head.score)
	// fmt.Println()
	// fmt.Println()

	// for _, f := range sl.head.forwards {
	...
	// sl.Insert("d", 98)
	// sl.Insert("e", 99)
	// fmt.Print(*sl.head.forwards[0])
	// fmt.Println()
	// fmt.Print(*sl.head.forwards[0].forwards[0])
	// fmt.Println()
	// fmt.Print(*sl.head.forwards[1].forwards[0])
	// fmt.Println()
	// fmt.Print(*sl.head.forwards[2].forwards[0])
	// fmt.Println()
	// fmt.Print(*sl.head.forwards[3].forwards[0])
	// fmt.Println()
	// fmt.Print(*sl.head.forwards[0].forwards[0].forwards[0])
	// fmt.Println()
	// fmt.Print(*sl.head.forwards[0].forwards[0].forwards[0].forwards[0])
	// fmt.Println()
	// fmt.Print(sl.head.forwards[0].forwards[0])
	// fmt.Println()
	// fmt.Print(sl)
